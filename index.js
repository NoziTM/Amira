...
client.on('message', function (message) {
        ...
        .setTitle("``Voici mes commandes d'aides ! \n Je me surnomme " + (client.user.tag) + "✨ créer par 𝙄𝙣𝙚𝙨❤[𝙉𝙤𝙯𝙞𝙏𝙈.ˣ⁻ᶜᵐᵈ]#0598``")
        ...
        .setFooter("Bot created bye 𝙄𝙣𝙚𝙨❤[𝙉𝙤𝙯𝙞𝙏𝙈.ˣ⁻ᶜᵐᵈ]#0598 ") 
        ...
        .addField("**instagram 📸**", "``Cette commande vous affichera le lien qui vous mènera sur la chaîne YouTube officiel de Nozi!``")
        .addField("**youtube 🎥**", "``Cette commande vous affichera le lien qui vous mènera sur le compte Instagram officiel de Nozi!``")
     ...
     .setURL("https://discordapp.com/oauth2/authorize?client_id=679284869980880896&permissions=8&scope=bot")
  ...
  .setFooter(`Commande invite`, message.author.avatarURL)
    ...
    var mentionned = message.mentions.members.first();
      ...
      //Social
        ...
        .addField("**PayPal **", "https://paypal.me/Noziytb67?locale.x=fr_FR")
      ...
      if(!args) return message.channel.send("Tu dois me dire quelque chose !")
       ...
       //Divers
          ...
          console.log("\x1b[2m")
           ...
           client.user.setActivity(`Nitro Free❤️`);
